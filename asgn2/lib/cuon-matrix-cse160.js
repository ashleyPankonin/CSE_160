...
class Vector3 {
    ...
    static cross(v1, v2) {
        let x = v1.elements[1]*v2.elements[2] - v1.elements[2]*v2.elements[1];
        let y = v1.elements[2]*v2.elements[0] - v1.elements[0]*v2.elements[2];
        let z = v1.elements[0]*v2.elements[1] - v1.elements[1]*v2.elements[0];
        let res = new Vector3();
        res.elements[0] = x;
        res.elements[1] = y;
        res.elements[2] = z;
